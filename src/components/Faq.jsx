...
function Faq() {
  return (
    <>
      <section id="FAQ" className="py-xxl-5 position-relative overflow- hidden">
        <span
        ...
        <div className="container py-md-5 my-md-5 z_index1">
          <div className="row justify-content-end mb-xl-5 pb-xl-5">
                ...
                <div className="mt-sm-5 mt-4">
                  ...
                  >
                    <Accordion.Item
                      ...
                      data-aos-offset="200"
                      className="Accordion_items position-relative pb-0"
                      eventKey="0"
                    >
                      <Accordion.Header className="accordion_Header pb-0">
                        <h2 className=" ff_gilroy-bold fs_2x4l text-white mb-0 py-md-3 py-1">
                          what are the main objectives of cyber security?
                        </h2>
                      </Accordion.Header>
                      <Accordion.Body>
                        <p className="m-0 ff_gilroy-medium fs_md text-white mb-0 mt-1">
                    ...
                    >
                      <Accordion.Header className="accordion_Header">
                        <h2 className="py-md-3 py-1 ff_gilroy-bold fs_2x4l text-white mb-0">
